...
FUNCTION (mico_idl idlfile)
  ...
  ADD_CUSTOM_COMMAND(
    OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${MICO_SOURCE_FILENAME}
    COMMAND cp ${idlfile} ${CMAKE_CURRENT_BINARY_DIR}/${MICO_SOURCE_FILENAME}
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
    DEPENDS ${idlfile}
  )
  ADD_CUSTOM_COMMAND(
    OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${MICO_SOURCE_FILENAME_WE}.h
    OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${MICO_SOURCE_FILENAME_WE}.cc
    COMMAND ${MICO_COMPILER_IDL} ${MICO_IDL_ARGS} ${MICO_SOURCE_FILENAME}
    WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
    MAIN_DEPENDENCY ${CMAKE_CURRENT_BINARY_DIR}/${MICO_SOURCE_FILENAME}
