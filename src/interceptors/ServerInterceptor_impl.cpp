...
credential ServerInterceptor::get_credential(PI::ServerRequestInfo &r)
{
  ...
  try 
  {
    ...
    any_credential = _orb_info->codec->decode_value(
      data, idl_cr::_tc_CredentialData);
    any_credential >>= credential_.data;
  }
