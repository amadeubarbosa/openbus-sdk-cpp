...
scs::core::ComponentId::ComponentId( const ComponentId& _s )
{
  ...
  major_version = ((ComponentId&)_s).major_version;
  minor_version = ((ComponentId&)_s).minor_version;
  patch_version = ((ComponentId&)_s).patch_version;
  platform_spec = ((ComponentId&)_s).platform_spec;
}
...
::CORBA::Boolean _Marshaller_scs_core_ComponentId::demarshal( ::CORBA::DataDecoder &dc, StaticValueType v ) const
{
  return
    ...
    CORBA::_stc_octet->demarshal( dc, &((_MICO_T*)v)->patch_version ) &&
    CORBA::_stc_string->demarshal( dc, &((_MICO_T*)v)->platform_spec._for_demarshal() ) &&
    dc.struct_end();
}
...
void _Marshaller_scs_core_ComponentId::marshal( ::CORBA::DataEncoder &ec, StaticValueType v ) const
{
  ...
  CORBA::_stc_octet->marshal( ec, &((_MICO_T*)v)->patch_version );
  CORBA::_stc_string->marshal( ec, &((_MICO_T*)v)->platform_spec.inout() );
  ec.struct_end();
}
